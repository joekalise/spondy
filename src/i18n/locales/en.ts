export default {
  ...
  home: {
    ...
    spondy_score_no_data: 'Track for a few days to see your score',
  ...
  profile: {
    ...
    track_medication_adherence: 'Track medication adherence',
    track_medication_on: 'Shown in daily check-in',
    track_medication_off: 'Hidden from daily check-in',
